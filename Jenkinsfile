...
pipeline {
   ...
   stages{
	...
	sh "echo $PATH"
	  ...
	  sh "/usr/local/bin/aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 819314761995.dkr.ecr.us-east-1.amazonaws.com/sample-app"
